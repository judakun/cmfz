...
<body>
<%=htmlData%>
<form name="example" type="post" action="${pageContext.request.contextPath}/articles/addArticle">
    标题：<input type="text" name="title" style="margin: 20px"/>&nbsp;&nbsp;&nbsp;&nbsp;
    作者：<input type="text" name="author" style="margin: 20px"/>
